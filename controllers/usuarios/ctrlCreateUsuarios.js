...
async function ctrlCreateUsuarios(req, res){
  try {
  const {name, lastName,phone,genero, country, email, direccion } = req.body
  console.log('Actualización Realizada')
  const usuariosx = await createUsuarios({name, lastName,phone,genero, country, email, direccion })
